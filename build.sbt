...
libraryDependencies += "org.lichess" %% "scalachess" % "8.6.25"
...
libraryDependencies += "com.typesafe.play" %% "play-ahc-ws-standalone" % "1.1.13"
libraryDependencies += "com.typesafe.play" %% "play-ws-standalone-json" % "1.1.13"
